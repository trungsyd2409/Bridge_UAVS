/**
 * Rerank: Gemini đọc câu hỏi và từng chunk CÙNG LÚC rồi chấm 0-10.
 * RRF tìm nhanh nhưng chưa hiểu sắc thái; rerank loại chunk "cùng chủ đề nhưng không
 * trả lời đúng câu hỏi" (ví dụ hỏi lương casual mà chunk nói về lương full-time).
 *
